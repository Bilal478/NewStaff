...
<body style="background-color:#E2E1E0;font-family: Open Sans, sans-serif;font-size:100%;font-weight:400;line-height:1.4;color:#000;">
	...
	<table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border: solid 1px grey;">
		...
		<tbody>
		  <tr>
			<td colspan="2" style="font-size:20px;padding:30px 15px 0 0px;font-weight:bold; color:#C9C9C9;">Invoice</td>
		  </tr>
		  <tr>
			<td colspan="2" style="padding:15px 15px 15px 0px;border-bottom: 1px solid #ddd;">
				<p style="font-size:14px;margin:0 0 6px 0;"><span style="color:#C9C9C9;font-weight:bold;display:inline-block;min-width:100px;">Your account: </span><?php echo $user_email;?></p>
				<p style="font-size:14px;margin:0 0 0 0;"><span style="color:#C9C9C9;font-weight:bold;display:inline-block; min-width:85px;">Billing date: </span><?php echo $date_at; ?></p>  
			</td>
		  </tr>
		  <tr>
			<td colspan="2" style="padding:20px 15px 15px 0px;font-weight:bold; border-bottom: 1px solid #ddd;">
				<strong style="font-size:20px;color:#0EA5E9;display:block;" >Thank you for your business.</strong><br>
		...
		<tr>
			<td colspan="2" style="font-size:14px;padding:20px 15px 0 0px;border-bottom: 1px solid #ddd; line-height: 150%;">
			  <strong style="display:inline-block;margin:0 0 10px 0; min-width:420px;">Subsciption</strong><strong>$<?php echo $subscription_price; ?></strong>
			  <br><br>
		...
		<tfooter>
		  <tr>
			<td colspan="2" style="font-size:14px;padding:20px 15px 0 0px;">
			  ...
			  <br><br>
			  <strong>You are all set </strong>.Your card has been charged, and further action is<br>
			  required on your part<br><br>
			</td>
		  </tr>
		</tfooter>
	</table>

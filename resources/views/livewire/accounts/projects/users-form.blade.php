    ...
    @role(['owner', 'manager'])
        <div class="pb-6 mb-2 border-b">
            <form wire:submit.prevent="add" class="flex items-center space-x-2">
                ...
                @else
                <button style="background: gray" class="button text-sm flex items-center rounded-md   text-white px-6 py-2   focus:outline-none   transition duration-150 ease-in-out h-10" disabled>Add</button>
